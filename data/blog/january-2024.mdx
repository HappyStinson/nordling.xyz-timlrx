...
- Created an account on Blocket marketplace[^1] and bookmarked several listings with concert and event tickets.
...
[^1]: Sweden's equivalent to Gumtree and Craigslist.
[^2]: I found Chris & Edi's workout channel in 2023 and did their 6-week Build Series at home.
[^3]: I signed up for this in 2021 when I first started reading Atomic Habits and began taking my habits more seriously. I couldn't keep up with the lessons, then fell off the wagon, and left it for future Ras to deal with.
[^4]: Homebrew Cask is like a helpful assistant for installing and managing software on macOS.
...
[Hilary Hahn performing together with the Swedish Radio Symphonic Orchestra](https://www.instagram.com/p/C2kBvwtiQmk/).

<div className="-mx-2 flex flex-wrap overflow-hidden xl:-mx-2">
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-1/2 xl:px-2">
    ![Pile of game money](/static/images/events/cashflow-101.jpeg)
  </div>
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-1/2 xl:px-2">
    ![Musicians inside Berwaldhallen](/static/images/events/berwaldhallen.jpeg)
  </div>
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-1/2 xl:px-2">
    ![Comparison of a BMW K1100RS before and after modifications](/static/images/events/bmw-k1100rs.jpeg)
  </div>
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-1/2 xl:px-2">
    ![Modified BMW K1100RS](/static/images/events/bmw-k1100rs-complete.jpeg)
  </div>
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-1/2 xl:px-2">
    ![Honda Gold Wing with a skeleton rider](/static/images/events/honda-goldwing.jpeg)
  </div>
</div>
...
<div>
  January scrabble words photo by [Glen Carrie](https://unsplash.com/@glencarrie)
  on
  [Unsplash](https://unsplash.com/photos/january-scrabble-words-TGeFx4x4NHU).
</div>